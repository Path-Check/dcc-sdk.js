...
describe('AT', async () => {
  ...
  it('should verify AT_2DCode_raw_2', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Musterfrau-Gößinger', 'fnt': 'MUSTERFRAU<GOESSINGER', 'gn': 'Gabriele', 'gnt': 'GABRIELE'}, 'dob': '1998-02-26', 'r': [{'tg': '840539006', 'fr': '2021-02-20', 'co': 'AT', 'is': 'BMSGPK Austria', 'df': '2021-04-04', 'du': '2021-10-04', 'ci': 'urn:uvci:01:AT:858CC18CFCF5965EF82F60E493349AA5Y'}]});
  });
