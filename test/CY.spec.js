...
describe('CY', async () => {
  it('should verify CY_2DCode_raw_6', async () => {
    ...
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Miguel', 'fnt': 'MIGUEL', 'gn': 'Francisco', 'gnt': 'FRANCISCO'}, 'dob': '1990-01-09', 'v': [{'tg': '840539006', 'vp': '1119305005', 'mp': 'EU/1/20/1528', 'ma': 'ORG-100001699', 'dn': 2, 'sd': 2, 'dt': '2021-06-02', 'co': 'CY', 'is': 'Ministry of Health', 'ci': 'dgci:V1:CY:IR9L8I84HFLFPNISN548LJIXJ:30'}]});
  });
  ...
  it('should verify CY_2DCode_raw_8', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Karaoli', 'fnt': 'KARAOLI', 'gn': 'Anastasia', 'gnt': 'ANASTASIA'}, 'dob': '1990-01-23', 'r': [{'tg': '840539006', 'fr': '2021-05-02', 'co': 'CY', 'is': 'Ministry of Health', 'df': '2021-06-02', 'du': '2021-12-02', 'ci': 'dgci:V1:CY:JDXP4L47UVVWHJMFBIJIGWNO6:44'}]});
  });
  ...
  it('should verify CY_2DCode_raw_5', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Miguel', 'fnt': 'MIGUEL', 'gn': 'Francisco', 'gnt': 'FRANCISCO'}, 'dob': '1990-01-09', 'v': [{'tg': '840539006', 'vp': '1119305005', 'mp': 'EU/1/20/1528', 'ma': 'ORG-100001699', 'dn': 1, 'sd': 2, 'dt': '2021-06-02', 'co': 'CY', 'is': 'Ministry of Health', 'ci': 'dgci:V1:CY:GRHC8O6ECPWMUM16D3WAXOPN4:89'}]});
  });
