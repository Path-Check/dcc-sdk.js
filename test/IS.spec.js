...
describe('IS', async () => {
  ...
  it('should verify IS_2DCode_raw_3', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'dob': '2000-01-01', 'nam': {'fn': 'Testingson', 'fnt': 'TESTINGSON', 'gn': 'Testing', 'gnt': 'TESTING'}, 't': [{'ci': '01 IS/ABC4557#6', 'co': 'IS', 'dr': '2021-05-17T18:21:16Z', 'is': 'Directorate of Health of Iceland Test', 'ma': '1304', 'sc': '2021-05-17T14:21:16Z', 'tc': 'Department of ClinicalMicrobiology,Landspitali', 'tg': '840539006', 'tr': '260415000', 'tt': 'LP6464-4'}], 'ver': '1.0.0'});
  });
  ...
  it('should verify IS_2DCode_raw_4', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'dob': '2000-01-01', 'nam': {'fn': 'Testingson', 'fnt': 'TESTINGSON', 'gn': 'Testing', 'gnt': 'TESTING'}, 't': [{'ci': 'URN:UVCI:01:IS:T123123323#7', 'co': 'IS', 'dr': '2021-05-26T13:32:15Z', 'is': 'Directorate of Health of Iceland Test', 'ma': '1304', 'sc': '2021-05-26T09:32:15Z', 'tc': 'Department of ClinicalMicrobiology,Landspitali', 'tg': '840539006', 'tr': '260415000', 'tt': 'LP6464-4'}], 'ver': '1.0.0'});
  });
