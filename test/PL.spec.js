...
describe('PL', async () => {
  it('should verify PL_2DCode_raw_6', async () => {
    ...
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 'v': [{'tg': '840539006', 'vp': 'J07BX03', 'mp': 'EU/1/21/1529', 'ma': 'ORG-100030215', 'dn': 2, 'sd': 2, 'dt': '2021-05-18', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'ci': 'URN:UVCI:01:PL:1/7934E5C11DAD485F9F27B20DA5A41082'}]});
  });
  ...
  it('should verify PL_2DCode_raw_7', async () => {
    ...
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 't': [{'tg': '840539006', 'tt': 'LP217198-3', 'ma': '9999', 'sc': '2021-05-24T15:20:00+02:00', 'dr': '2021-05-24T15:40:00+02:00', 'tr': '260415000', 'tc': 'Narodowe centrum testowania', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'ci': 'URN:UVCI:01:PL:2/6E4B336EAD9B11EB85290242AC130003'}]});
  });
  ...
  it('should verify PL_2DCode_raw_10', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 'r': [{'tg': '840539006', 'fr': '2021-01-07', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'df': '2021-01-18', 'du': '2021-04-18', 'ci': 'URN:UVCI:01:PL:3/6E4B336EAD9B11EB85290242AC130003'}]});
  });
  ...
  it('should verify PL_2DCode_raw_3', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 'r': [{'tg': '840539006', 'fr': '2021-05-07', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'df': '2021-05-18', 'du': '2021-09-05', 'ci': 'URN:UVCI:01:PL:3/655052DD53A649E897FA10AC9C175654'}]});
  });
  ...
  it('should verify PL_2DCode_raw_8', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 'r': [{'tg': '840539006', 'fr': '2021-05-07', 'co': 'XY', 'is': 'Centrum e-Zdrowia', 'df': '2021-05-18', 'du': '2021-09-05', 'ci': 'URN:UVCI:01:PL:3/6E4B336EAD9B11EB85290242AC130003'}]});
  });
  ...
  it('should verify PL_2DCode_raw_4', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 't': [{'tg': '840539006', 'tt': 'LP6464-4', 'nm': 'Roche LightCycler qPCR', 'sc': '2021-05-24T20:10:00+02:00', 'dr': '2021-05-25T14:20:00+02:00', 'tr': '260415000', 'tc': 'Narodowe centrum testowania', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'ci': 'URN:UVCI:01:PL:2/710B50E7F8F842C59D2DA913885C603F'}]});
  });
  ...
  it('should verify PL_2DCode_raw_5', async () => {
    ...
    expect(cwtPayload).not.to.be.null;
    expect(cwtPayload).not.to.be.undefined;
    expect(await parseCWT(cwtPayload.contents)).to.eql({'ver': '1.0.0', 'nam': {'fn': 'Rogaliński-Król', 'fnt': 'ROGALINSKI<KROL', 'gn': 'Stanisław', 'gnt': 'STANISLAW'}, 'dob': '1958-11-11', 't': [{'tg': '840539006', 'tt': 'LP217198-3', 'ma': '1232', 'sc': '2021-05-24T12:20:00+02:00', 'dr': '2021-05-24T12:40:00+02:00', 'tr': '260415000', 'tc': 'Narodowe centrum testowania', 'co': 'PL', 'is': 'Centrum e-Zdrowia', 'ci': 'URN:UVCI:01:PL:2/6E4B336EAD9B11EB85290242AC130003'}]});
  });
